# H-38 — residual DINOv3 + CoAtNet em rank por alvo

## Objetivo

Testar se uma contribuição pequena do braço DINOv3 melhora o baseline H-36
(CoAtNet Max-Span, `0,928`) quando os dois são combinados em rank por alvo.
O H-37, com 50/50, marcou `0,922`; portanto o H-38 reduz o DINOv3 a um
residual de 20% e preserva 80% do braço CoAtNet. O candidato é uma fusão de
famílias visuais públicas, não uma reutilização de output de kernel privado.
...
- Fusão final: ranks por coluna, com exatamente 20% do braço DINOv3 e 80% do
...
- A versão H-38 não usa RadImageNet, DINOv3 hospedado de origem incerta,
...
4. Promover apenas se superar H-36 `0,928`; se não superar, manter H-36 como
   produção e guardar o H-38 apenas como diagnóstico de residual.

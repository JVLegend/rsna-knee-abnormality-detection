#!/usr/bin/env python3
"""H-26 — H-23 com pooling mean em todos os alvos. #RSNA #Kaggle #Dados

Esta variante preserva a configuração H-23 (dense6, EfficientNet-B0,
...
o pooling de probabilidades deixa de usar top-k por alvo e passa a usar média
para os 12 alvos. O fine-tuning de uma época somente no último bloco do
encoder, o head auxiliar descartável e o blend texto-imagem continuam iguais.
...
TARGET_VIEW_POOLING = {
    "ACL": "mean",
    "MCL": "mean",
    "Medial Meniscus": "mean",
    "Lateral Meniscus": "mean",
    "Medial OA": "mean",
    "Lateral OA": "mean",
    "PF OA": "mean",
    "Effusion": "mean",

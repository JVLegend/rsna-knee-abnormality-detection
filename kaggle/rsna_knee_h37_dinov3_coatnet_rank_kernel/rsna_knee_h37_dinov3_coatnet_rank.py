"""H-37: independent DINOv3 five-fold arm fused with the H-36 CoAtNet arm.
...
per-target rank fusion. No private kernel output is an input.
"""
...
# H-37 deliberately omits the DINOv2/RadImageNet branch from the source notebook.
...
# H-37 has no pre-existing transformer parent: persist the exact DINOv3 fold rank mean
...
print('H-37 transformer parent = DINOv3 five-fold rank mean', _a5_out.shape, flush=True)

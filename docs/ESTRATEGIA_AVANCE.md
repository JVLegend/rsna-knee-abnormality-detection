...
- AV-029: V05 metadados concluídos/auditados; G04 BLOQUEADO POR CONCORRÊNCIA.
  ...
  1.000treino/954grupos preservados; novos dev300/297grupos e
  confirmação300/299grupos;2.290não usados. Seed20260921/namespaceV05,
  seleção por hash de grupos inteiros, sem busca de seed/prevalência.
  Cobertura12alvos passou; Fracture reservado18positivos/110negativos/
  172incertos, ainda referência fraca. Nenhuma predição dos novos conjuntos.
  OOF5folds260estudos sobre treino+novo dev, sem grupos cruzados; desenho
  somente, não OOF calculado. Épocas futuras não podem ser escolhidas no
  próprio fold avaliado: fixar ou usar validação interna apenas no treino.
  Piloto G04:20estudos de treino,60séries; hash de seleção fixo, sem labels
  ou IDs reservados no kernel. Decoder/geometria/FOV nativo iguais,
  apenas resize224vs336; encoder oficial congelado, não testar cabeça224
  com embeddings336. Conferir paridade224 com cache histórico/pixels.
  Build reports/avance_av029_g04/preflight_v1.py,66.245bytes,

...
| H-41 | O checkpoint WideDense completo do mesmo ecossistema público supera H-38 como modelo primário | `dreaddevelopment/raptor-knee-widedense/raptor_ft_coatnet_v4_full.pt`; CoAtNet RMLP 2 RW 384, 336 px, crop 140 mm e janelas sobrepostas; fonte declarada `CC0-1.0`; checkpoint auditado no HD externo com SHA-256 `89606f05849838529e1b4658d28fb049623205d9853371548403bca460361ded` | Exigir OOF independente ou score Kaggle acima de `0,929`; não calibrar no leaderboard de apenas 3 estudos | **Triagem negativa, não executada**: página pública do kernel informa `0,924` e o próprio checkpoint registra `gold_auc=0,916749`; guardar para um blend fold-conditioned, não trocar o baseline |

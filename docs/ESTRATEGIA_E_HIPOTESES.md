...
- H-37 foi executada em
  ...
  pendentes; para promoção, o resultado deve superar `0,928`.
...
10. H-37 concluiu a execução autorizada: DINOv3 público independente + H-36
    ...
    reutilizou o CSV H-36 como input. A submissão Notebook-only segue pendente
    de confirmação e o score precisa superar `0,928` para promoção.

### Próxima atualização

H-36 (`0,928`) é a nova referência protegida; H-37 está executada e aguarda
submissão/score;
H-34 (`55856090`, `0,899`),
H-29 (`0,759`), H-27

...
| 07/08/2026 | `v0_report_metadata` | TF-IDF de laudo + sexo + atributos de séries, um classificador por alvo | Metadados disponíveis; executar baseline local com 58 rótulos por alvo | A executar | Candidato inicial |

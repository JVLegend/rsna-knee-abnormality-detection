...
| 09/08/2026 (UTC 09/08) | `kaggle_kernel_v3_weak_visual_v10` | Executar de fato a weak supervision visual com o fallback CUDA atualizado | Código local `15 passed`; pacote terá `weak_visual=True`, batch `32`, T4 solicitado e internet desligada; aguardando execução | — | Candidata operacional; só promover após confirmar `weak_visual=True` no log e CSV íntegro |
